...
{
	$to = 'info@tsg.com.gt';
	$subject = 'Envío de Contacto Sugerencias';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre:</b></td><td>' . htmlentities($_REQUEST["custom_U1728"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Mensaje:</b></td><td>' . htmlentities($_REQUEST["custom_U1705"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Asunto:</b></td><td>' . htmlentities($_REQUEST["custom_U1734"],ENT_COMPAT,'UTF-8') . '</td></tr>';
