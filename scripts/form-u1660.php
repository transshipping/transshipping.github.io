...
{
	$to = 'info@tsg.com.gt';
	$subject = 'Envío de Formulario Contacto Servicio al cliente';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre:</b></td><td>' . htmlentities($_REQUEST["custom_U1661"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Mensaje:</b></td><td>' . htmlentities($_REQUEST["custom_U1669"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Asunto:</b></td><td>' . htmlentities($_REQUEST["custom_U1679"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Teléfono móvil:</b></td><td>' . htmlentities($_REQUEST["custom_U1674"],ENT_COMPAT,'UTF-8') . '</td></tr>';
